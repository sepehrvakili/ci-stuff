...
# variable expansion!
mongo -u $MONGO_INITDB_ROOT_USERNAME -p $MONGO_INITDB_ROOT_PASSWORD admin --eval "dbname='$MONGO_RRN_DB', username='$MONGO_USER', dbpass='$MONGO_PASS'" /docker-entrypoint-initdb.d/mongo-init